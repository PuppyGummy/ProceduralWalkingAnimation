...
public static class MathExtension
{
    ...
    public static void MatchUp(this Transform transform, Vector3 up)
    {
        transform.rotation = RotationMatchUp(transform.rotation, up);
        // set the rotation smoothly
        // transform.rotation = Quaternion.Slerp(transform.rotation, RotationMatchUp(transform.rotation, up), Time.deltaTime * 10);
    }
